...
| CWS-PILOT-READINESS-004 | Codex | In progress — core controls pushed | Added readiness coverage, independent variant editing/status controls, immutable-history revision re-submission, and workspace-owned decision/learning creation in `695b765` | Confirm deployment and run one complete CWS-001 pilot cycle; then choose campaign status control or the future export/outcome migration |
