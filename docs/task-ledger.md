...
| CWS-PILOT-READINESS-004 | Codex | In progress — core controls complete locally | Added readiness coverage, independent variant editing/status controls, immutable-history revision re-submission, and workspace-owned decision/learning creation | Push and run one complete CWS-001 pilot cycle; then choose campaign status control or the future export/outcome migration |
