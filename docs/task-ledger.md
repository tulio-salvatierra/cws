...
| CWS-PILOT-READINESS-004 | Codex | In progress — all migration-free controls pushed | Added campaign and variant lifecycle controls, immutable-history revision re-submission, workspace-owned decision/learning creation, and readiness coverage through `5b5161a` | Confirm deployment and run one complete CWS-001 pilot cycle; then design the future export/outcome migration from the live findings |
