...
| CWS-CAMPAIGN-UX-007 | Codex | Completed locally; deployment pending | Maps Supabase `23505` to an accessible workspace-scoped duplicate campaign-code message while retaining database enforcement; 68 tests pass | Push/deploy, verify one repeated code, then resume approval history and the revision cycle |
