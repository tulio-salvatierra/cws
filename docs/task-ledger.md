...
| CWS-PILOT-READINESS-004 | Codex | In progress — all migration-free controls complete locally | Added campaign and variant lifecycle controls, immutable-history revision re-submission, workspace-owned decision/learning creation, and readiness coverage | Push, deploy, and run one complete CWS-001 pilot cycle; then design the future export/outcome migration from the live findings |
