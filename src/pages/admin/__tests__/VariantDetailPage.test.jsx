...
describe('VariantDetailPage', () => {
  ...
  it('does not offer a retired n8n action for an exported variant', async () => {
    const exportedVariant = {
      ...variant,
      status: 'exported',
      exported_by: 'user-1',
    ...
    await screen.findByRole('heading', { name: 'Current export · version 1' })
    expect(fetchMock).not.toHaveBeenCalled()
    expect(screen.queryByRole('button', { name: 'Test n8n handoff' })).not.toBeInTheDocument()
